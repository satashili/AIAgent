      ...
      ? [
        {
          ...
          onClick: () => {
            window.open(
              'https://www.baidu.com/s?wd=%E5%A4%A7%E6%A8%A1%E5%9E%8B&rsv_spt=1&rsv_iqid=0x9e967636001dab6e&issp=1&f=8&rsv_bp=1&rsv_idx=2&ie=utf-8&tn=baiduhome_pg&rsv_dl=tb&rsv_enter=1&rsv_sug3=10&rsv_sug1=9&rsv_sug7=100&rsv_sug2=0&rsv_btype=i&inputT=3231&rsv_sug4=4276',
              '_blank'
            );
          }
        },
      ...
      ? [
        {
          ...
          key: 'docs',
          onClick: () => {
            window.open('https://zhuanlan.zhihu.com/p/649779973');
          }
        }
      ]
      : [])
